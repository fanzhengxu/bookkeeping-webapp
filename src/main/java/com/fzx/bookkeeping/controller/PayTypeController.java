...
public class PayTypeController {
    ...
    public JSONObject selectAll(HttpServletRequest request) {
        ...
        List<Map<String, Object>> maps = jdbcTemplate.queryForList("select id, name, enable from t_payType where user_id = ?", id);
    ...
    public JSONObject enable(HttpServletRequest request) {
        ...
        jdbcTemplate.update("update t_payType set enable = ? where id = ?", enable, id);
        jsonObject.put("status", 200);
        jsonObject.put("msg", "添加成功");
        return jsonObject;
    }
    ...
    public JSONObject del(HttpServletRequest request) {
        ...
        jdbcTemplate.update("delete from t_payType where id = ?", Integer.valueOf(id));
        jsonObject.put("status", 200);
        jsonObject.put("msg", "添加成功");
        return jsonObject;
    }
